...
char body_html[] = R"=====(
	<body>
		...
		<div id="bar">
			<table >
				<tr >
					<td id="color"><a href="RED"><div id="red"></div></a></td>
					<td id="color"><a href="/GREEN"><div id="green"></div></a></td>
					<td id="color"><a href="/YELLOW"><div id="yellow"></div></a></td>
					<td id="color"><a href="/BLUE"><div id="blue"></div></a></td>
				</tr>
			</table>	
		</div>
